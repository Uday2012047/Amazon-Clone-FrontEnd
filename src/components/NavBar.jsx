         ...
         <div className="flex bg-amazoneclone text-white h-[60px]">
            ...
            <div className="flex items-center m-4 ">
               ...
               <div className="pl-4 pt-5">
                  <Icon className=" text-xl " icon="heroicons-outline:location-marker" />
               </div>
            ...
            <div className="flex items-center m-4">
               ...
               <Link to={"/checkout"}>
                  <div className=" flex pr-3 pl-3">
                     <ShoppingCartIcon className="h-[44px]" />
                     <div className='relative'>
                        <div className='absolute right-[9px] font-bold m-[5px] text-orange-400'>
                           {cart}
                        </div>
                     </div>
